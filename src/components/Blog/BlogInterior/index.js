      ...
      <div className="blog-interior__blog-details-container">
        ...
        <div className="blog-interior__blog-details-container__author-article">
          <p className="paragraph part-n">
            ...
            magna neque, netus pellentesque quam. Pretium, id arcu ipsum leo in
            gravida nisl egestas. Ut quis donec venenatis urna, id non. Pharetra
            nunc, ut eget et neque eu. Nibh vel sagittis, id elementum
            consectetur. Suspendisse turpis adipiscing imperdiet dignissim ut
            quisque proin imperdiet. Vulputate praesent commodo est turpis.
            Lectus nunc semper gravida velit convallis tempor ac et.
          </p>
          <p className="paragraph part-n">
            Sit fermentum ullamcorper in fermentum vitae quisque. Eu ultricies
            quis bibendum cras turpis eget ullamcorper vel. Ipsum urna neque,
        ...
        <div className="blog-interior__blog-details-container__article-quote-image">
          <div className="blog-interior__blog-details-container__article-quote-image__container">
            ...
            <p>
              ...
              sit. Amet, hac sed tincidunt tempus nulla. Neque mi, auctor donec
              amet, libero eget accumsan elit sem. A nunc ut integer in sit vel
              velit elementum.
            </p>
          </div>
          <p className="paragraph part-last part-n">
            ...
            sed. Suspendisse fames neque semper massa justo, faucibus convallis
            eget vitae. Sem scelerisque consequat, purus nulla neque,
            pellentesque. Nec, odio sem ultrices consequat lobortis ac non.
            Tincidunt amet feugiat nunc quam. Ultrices arcu nullam et est diam
            fermentum aliquet quisque luctus.
          </p>
