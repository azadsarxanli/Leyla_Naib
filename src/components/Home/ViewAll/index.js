...
const ViewAll = () => {
    ...
    const [imageContainerScrollHeight, setImageContainerScrollHeight] = useState(0);
    ...
    return (
        <section className='view-all'>
            ...
            <div className='view-all__images-section'>
                <div className='view-all__images-section__cards' onScroll={onScrollContainer} ref={imageContainer} >
