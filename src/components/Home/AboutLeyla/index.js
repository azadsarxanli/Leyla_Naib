        ...
        <section className="about-leila">
            ...
            <div className="about-leila__description">
                <div className="about-leila__description__texts">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas tortor id ut a tempor. In aliquam amet est mauris velit, venenatis tempor proin. Ultrices in phasellus suspendisse et, urna. Fermentum elementum aliquam mattis luctus. Eu orci aliquam tincidunt enim. Facilisis odio eget morbi at nulla nisi. Mauris, 
                        ipsum convallis diam gravida tristique. Luctus aliquam in a tristique.
                    </p>
                </div>
